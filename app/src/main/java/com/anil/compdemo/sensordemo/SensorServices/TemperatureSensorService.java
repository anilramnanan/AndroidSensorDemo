...
public class TemperatureSensorService extends Service implements SensorEventListener {
    ...
    public static final String Temperature_OUT_MSG = "out";
    public static final String Temperature_IN_MSG = "in";
    ...
    public void onCreate() {
        ...
        accelSensor = sensorManager.getDefaultSensor(Sensor.TYPE_AMBIENT_TEMPERATURE);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        broadcastIntent.setAction(TemperatureBroadcastReceiver.Temperature_ACTION_RESP);
        broadcastIntent.putExtra(Temperature_OUT_MSG, sensorResult);
        sendBroadcast(broadcastIntent);
        System.out.println("Temperature sensor changing");

        DBHelper db = new DBHelper(this);
        db.addSensorRecord(new SensorModel("Temperature Sensor",sensorResult,"0","0"));
